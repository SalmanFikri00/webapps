...
function Mallware() {
  return (
    <div className='w-screen bg-gray-900'>
        <LandingSection title1='Apakah kamu pernah mendengar tentang mallware' content="yukk cari tahu apa itu mallware..." title2='DDOS' size1='1.5vw' size2='7vw' img={mallwareimg} button={false}/>
        <div>
